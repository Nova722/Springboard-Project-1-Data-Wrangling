...
This was an assignment from my Springboard "Introduction to Data Science course".
The data set and exercise are inspired by this [blog post](http://d3-media.blogspot.com/2013/11/how-to-refine-your-data.html).
